          ...
          <div className="flex gap-4">
            {SOCIALS.map(({ label, href, Icon }) => (
              <Link
                ...
                href={href}
                aria-label={label}
                className="flex h-9 w-9 items-center justify-center border border-paper/30 text-paper/80 transition-colors hover:border-blue hover:bg-blue hover:text-paper"
              >
